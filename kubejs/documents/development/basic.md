...
打开 [Minecraft-Hunt GitHub 仓库](https://github.com/CrychicTeam/Minecraft-Hunt)，点击右上角的 "Fork" 按钮，将项目 Fork 到你的 GitHub 账户中。
...
```bash
git remote add upstream https://github.com/CrychicTeam/Minecraft-Hunt.git
```
